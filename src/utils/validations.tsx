...
function compareDates(selectedDate?: any, testDate?: any, isAfter?: any, messageFormat?: any) {
...
function isDATE(date?: any, minDate?: any, maxDate?: any, messageFormat = "dd/MM/yyyy") {
  if (!date) {
...
function errorTreatment(fieldName: any, ffHandler: any, name: any, callback: any) {
